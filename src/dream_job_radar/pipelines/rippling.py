"""Run the Rippling slice of dream-job-radar.

Loads Rippling job-board roles into Cloudflare R2 as Parquet under
`s3://<bucket>/raw/rippling/<slug>/`.
...
from dream_job_radar.extractors.rippling import DEFAULT_BOARDS, board_resources
